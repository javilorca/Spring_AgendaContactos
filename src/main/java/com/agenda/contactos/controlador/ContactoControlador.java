...
public class ContactoControlador {
	...
	@PostMapping("/nuevo") // BindingResult obtiene todos los errores y los muestra
	public String guardarContacto(@Validated Contacto contacto, RedirectAttributes redirect,
		...
		redirect.addFlashAttribute("msgExito", "El contacto se ha registrado con éxito");
		return "redirect:/";
	...
	@PostMapping("/{id}/editar") // BindingResult obtiene todos los errores y los muestra
	public String actualizarContacto(@PathVariable Integer id, @Validated Contacto contacto, RedirectAttributes redirect,
			BindingResult bindingResult, Model modelo) {
		...
		contactoRepositorio.save(contacto);
		redirect.addFlashAttribute("msgExito", "El contacto se ha actualizado con éxito");
		return "redirect:/";
